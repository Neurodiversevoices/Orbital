/**
 * orbConstants.ts — Shared constants for Clinical Orb v8
 */
...
export const HOUSING_OUTER_RADIUS = ORB_SIZE / 2 + 16;
...
export const HOUSING_BEVEL_LIGHT = 'rgba(255, 255, 255, 0.06)';
export const HOUSING_BEVEL_DARK = 'rgba(0, 0, 0, 0.4)';
export const HOUSING_INNER_SHADOW = 'rgba(0, 0, 0, 0.6)';

export const GLASS_SPECULAR_OPACITY = 0.08;
export const GLASS_VIGNETTE_OPACITY = 0.35;
export const LENS_IOR = 1.15;
export const CHROMATIC_ABERRATION = 0.003;

export const NODE_COUNT = 100;
export const PATHWAY_COUNT = 10;
...
export const SCRATCH_OPACITY = 0.02;
export const SCRATCH_COUNT = 8;
...
export const GAUGE_NEEDLE_SHADOW_BLUR = 4;
export const GAUGE_GLASS_OPACITY = 0.06;
