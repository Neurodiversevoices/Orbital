...
export const ja = {
  ...
  accessibility: {
    ...
    simpleMode: 'シンプルモード',
    simpleModeDesc: 'ワンタップで最大のアクセシビリティ',
  ...
  teamMode: {
    ...
    noTeam: 'チームに所属していません',
    noTeamDesc: 'チームコードを入力して職場のパルスに参加',
    joinSuccess: 'チームに参加しました',
    leaveSuccess: 'チームを離れました',
    ...
    trendStable: '安定',
    trendDeclining: '低下中',
    participationConfidence: 'データ信頼性',
    confidenceHigh: '高',
    confidenceMedium: '中',
    confidenceLow: '低',
  ...
  schoolZone: {
    ...
    studentViewDesc: 'キャパシティを記録して自分を助け、サポートを受ける',
    goToLog: '今すぐ記録',
    caregiverViewTitle: '学校サマリーカード',
    caregiverViewDesc: '教育者と共有するサマリーを作成',
    ...
    cardEntriesCount: 'この期間の記録数：{count}',
