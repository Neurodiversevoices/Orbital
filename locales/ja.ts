...
export const ja = {
  ...
  teamMode: {
    ...
    noTeam: 'チームに所属していません',
    noTeamDesc: 'チームコードを入力して職場のキャパシティパルスに参加しましょう',
    joinSuccess: 'チームに正常に参加しました',
    leaveSuccess: 'チームから正常に離脱しました',
    leaveConfirmTitle: 'チームを離脱',
    leaveConfirmMessage: 'チームコードがあればいつでも再参加できます。',
    privacyBanner: '個人データは共有されません。チームの集計データのみが表示されます。',
    thresholdWarning: '集計データを表示するには、チームに最低{min}名の参加者が必要です',
    participantCount: '{count}名の参加者',
  ...
  schoolZone: {
    ...
    noSchoolDesc: '学校コードを入力して学校機能にアクセスしましょう',
    joinSuccess: 'スクールゾーンに正常に参加しました',
    leaveSuccess: 'スクールゾーンから正常に離脱しました',
    leaveConfirmTitle: 'スクールゾーンを離脱',
    leaveConfirmMessage: '学校コードがあればいつでも再参加できます。',
    roleLabel: '私は',
    roleStudent: '生徒',
    roleCaregiver: '保護者',
    roleEducator: '教育者',
    privacyBanner: '生徒の個人データは教育者と共有されません。クラスの集計データのみが表示されます。',
    thresholdWarning: '集計データを表示するには、クラスに最低{min}名の生徒が必要です',
    studentCount: '{count}名の生徒',
    studentViewTitle: 'あなたのキャパシティ',
    studentViewDesc: 'キャパシティを記録して自分を助け、サポートを受けましょう',
    goToLog: '今すぐ記録',
    caregiverViewTitle: '学校サマリーカード',
    caregiverViewDesc: '教育者と共有するためのサマリーを作成します',
    ...
    cardWhatDrains: '負担になるもの',
    cardEntriesCount: '期間中の{count}件のエントリ',
    notesExcluded: 'プライバシー保護のため個人メモは除外されています',
    ...
    envFactors: {
      quiet_space: '静かな場所',
      sensory_tools: '感覚ツール',
      movement_breaks: '体を動かす休憩',
      extra_time: '追加の時間',
      small_groups: '少人数グループ',
      check_ins: '確認・声かけ',
      loud_environment: 'うるさい環境',
      bright_lights: 'まぶしい照明',
      time_pressure: '時間的プレッシャー',
      multiple_instructions: '複数の指示',
      crowded_spaces: '混雑した場所',
