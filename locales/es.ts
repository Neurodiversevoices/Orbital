...
export const es = {
  ...
  teamMode: {
    title: 'Modo Equipo',
    subtitle: 'Pulso de capacidad laboral opcional',
    ...
    noTeam: 'No formas parte de un equipo',
    noTeamDesc: 'Ingresa un código de equipo para unirte al pulso laboral',
  ...
  schoolZone: {
    ...
    schoolCodePlaceholder: 'Ingresa el código escolar',
    schoolCodeInvalid: 'Código escolar inválido',
    noSchool: 'No inscrito en una zona escolar',
    noSchoolDesc: 'Ingresa un código escolar para acceder a las funciones escolares',
    ...
    leaveConfirmMessage: 'Puedes volver a unirte en cualquier momento con el código escolar.',
    roleLabel: 'Soy',
    ...
    cardEntriesCount: '{count} registros en el período',
    notesExcluded: 'Notas personales excluidas por privacidad',
    educatorViewTitle: 'Panorama de capacidad de la clase',
