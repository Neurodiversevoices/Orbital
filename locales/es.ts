...
export const es = {
  ...
  accessibility: {
    ...
    simpleModeDesc: 'Máxima accesibilidad con un solo toque',
  ...
  teamMode: {
    title: 'Modo Equipo',
    subtitle: 'Pulso opcional de capacidad del lugar de trabajo',
    joinTeam: 'Unirse al Equipo',
    leaveTeam: 'Salir del Equipo',
    teamCode: 'Código de Equipo',
    teamCodePlaceholder: 'Introduce el código de equipo',
    teamCodeInvalid: 'Código de equipo inválido',
    noTeam: 'No forma parte de un equipo',
    noTeamDesc: 'Introduce un código de equipo para unirte al pulso de tu lugar de trabajo',
    joinSuccess: 'Te uniste al equipo exitosamente',
    leaveSuccess: 'Saliste del equipo exitosamente',
    ...
    participationConfidence: 'Confianza en los Datos',
    confidenceHigh: 'Alta',
    confidenceMedium: 'Media',
    confidenceLow: 'Baja',
    totalSignals: '{count} señales en este período',
  ...
  schoolZone: {
    title: 'Zona Escolar',
    subtitle: 'Soporte de capacidad para entornos educativos',
    joinSchool: 'Unirse a la Escuela',
    leaveSchool: 'Salir de la Escuela',
    schoolCode: 'Código de Escuela',
    schoolCodePlaceholder: 'Introduce el código de escuela',
    schoolCodeInvalid: 'Código de escuela inválido',
    noSchool: 'No inscrito en una zona escolar',
    noSchoolDesc: 'Introduce un código de escuela para acceder a las funciones escolares',
    joinSuccess: 'Te uniste a la zona escolar exitosamente',
    leaveSuccess: 'Saliste de la zona escolar exitosamente',
    leaveConfirmTitle: 'Salir de la Zona Escolar',
    ...
    privacyBanner: 'Los datos individuales de los estudiantes nunca se comparten con los educadores. Solo los datos agregados de la clase son visibles.',
    ...
    caregiverViewTitle: 'Tarjeta Resumen Escolar',
    caregiverViewDesc: 'Genera un resumen para compartir con los educadores',
    generateCard: 'Generar Tarjeta Resumen',
    ...
    cardWhatHelps: 'Lo que Ayuda',
    cardWhatDrains: 'Lo que Agota',
    ...
    educatorViewDesc: 'Vista agregada de los patrones de capacidad de la clase',
    classCapacity: 'Distribución de Capacidad de la Clase',
    classDrivers: 'Factores de la Clase',
    classConfidence: 'Confianza en los Datos',
    envFactors: {
      ...
      loud_environment: 'Entorno ruidoso',
      bright_lights: 'Luces brillantes',
      time_pressure: 'Presión de tiempo',
      multiple_instructions: 'Instrucciones múltiples',
      crowded_spaces: 'Espacios concurridos',
