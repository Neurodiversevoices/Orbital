...
export const ptBR = {
  ...
  teamMode: {
    title: 'Modo Equipe',
    subtitle: 'Pulso de capacidade do local de trabalho (opcional)',
  ...
  schoolZone: {
    ...
    noSchoolDesc: 'Digite um código escolar para acessar os recursos da escola',
    ...
    educatorViewTitle: 'Panorama de capacidade da turma',
