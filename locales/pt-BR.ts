...
export const ptBR = {
  ...
  teamMode: {
    title: 'Modo Equipe',
    subtitle: 'Pulso opcional de capacidade do local de trabalho',
    ...
    noTeamDesc: 'Digite um código de equipe para participar do pulso do seu local de trabalho',
    joinSuccess: 'Entrou na equipe com sucesso',
    leaveSuccess: 'Saiu da equipe com sucesso',
    leaveConfirmTitle: 'Sair da Equipe',
    leaveConfirmMessage: 'Você pode voltar a qualquer momento com o código da equipe.',
    privacyBanner: 'Seus dados individuais nunca são compartilhados. Apenas dados agregados da equipe são visíveis.',
    thresholdWarning: 'A equipe precisa de pelo menos {min} participantes para exibir dados agregados',
  ...
  schoolZone: {
    ...
    noSchool: 'Não matriculado em uma zona escolar',
    ...
    leaveConfirmMessage: 'Você pode voltar a qualquer momento com o código da escola.',
    roleLabel: 'Eu sou',
    roleStudent: 'Estudante',
    roleCaregiver: 'Responsável',
    roleEducator: 'Educador',
    privacyBanner: 'Dados individuais dos alunos nunca são compartilhados com educadores. Apenas dados agregados da turma são visíveis.',
    thresholdWarning: 'A turma precisa de pelo menos {min} alunos para exibir dados agregados',
    studentCount: '{count} alunos',
    studentViewTitle: 'Sua Capacidade',
    studentViewDesc: 'Registre sua capacidade para se ajudar e receber apoio',
    goToLog: 'Registrar Agora',
    caregiverViewTitle: 'Cartão Resumo Escolar',
    caregiverViewDesc: 'Gere um resumo para compartilhar com os educadores',
    generateCard: 'Gerar Cartão Resumo',
    ...
    cardEntriesCount: '{count} registros no período',
