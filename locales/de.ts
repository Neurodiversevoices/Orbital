...
export const de = {
  ...
  teamMode: {
    title: 'Team-Modus',
    subtitle: 'Optionaler Kapazitätspuls am Arbeitsplatz',
    ...
    noTeamDesc: 'Geben Sie einen Team-Code ein, um dem Kapazitätspuls Ihres Arbeitsplatzes beizutreten',
  ...
  schoolZone: {
    ...
    roleLabel: 'Ich bin',
    roleStudent: 'Schüler',
    roleCaregiver: 'Erziehungsberechtigter',
    roleEducator: 'Lehrkraft',
    privacyBanner: 'Individuelle Schülerdaten werden niemals mit Lehrkräften geteilt. Nur aggregierte Klassendaten sind sichtbar.',
    ...
    educatorViewTitle: 'Klassenkapazität Übersicht',
