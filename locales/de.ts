...
export const de = {
  ...
  accessibility: {
    ...
    simpleModeDesc: 'Maximale Barrierefreiheit mit einem Tipp',
  ...
  teamMode: {
    title: 'Team-Modus',
    subtitle: 'Kapazitätspuls am Arbeitsplatz (optional)',
    ...
    noTeam: 'Sie sind nicht Teil eines Teams',
    ...
    totalSignals: '{count} Signale diese Periode',
    actionPanelTitle: 'Vorgeschlagene Aktionen',
    noSuggestions: 'Keine Vorschläge zu diesem Zeitpunkt',
  },
  ...
  schoolZone: {
    title: 'Schulzone',
    subtitle: 'Kapazitätsunterstützung für Bildungsumgebungen',
    ...
    noSchool: 'Sie sind nicht in einer Schulzone eingeschrieben',
    ...
    roleCaregiver: 'Betreuer/in',
    roleEducator: 'Pädagoge/in',
    privacyBanner: 'Individuelle Schülerdaten werden nie mit Pädagogen geteilt. Nur aggregierte Klassendaten sind sichtbar.',
    ...
    educatorViewTitle: 'Klassenkapazitäts-Übersicht',
    educatorViewDesc: 'Aggregierte Ansicht der Klassenkapazitätsmuster',
    ...
    envFactors: {
      ...
      multiple_instructions: 'Mehrere Anweisungen',
