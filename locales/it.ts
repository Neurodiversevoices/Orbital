...
export const it = {
  ...
  accessibility: {
    ...
    simpleModeDesc: 'Massima accessibilità con un solo tocco',
  ...
  teamMode: {
    title: 'Modalità Team',
    subtitle: 'Polso opzionale della capacità sul luogo di lavoro',
    ...
    joinSuccess: 'Iscrizione al team avvenuta con successo',
    leaveSuccess: 'Uscita dal team avvenuta con successo',
  ...
  schoolZone: {
    ...
    joinSuccess: 'Iscrizione alla zona scolastica avvenuta con successo',
    leaveSuccess: 'Uscita dalla zona scolastica avvenuta con successo',
    ...
    educatorViewDesc: 'Vista aggregata dei modelli di capacità della classe',
    classCapacity: 'Distribuzione di Capacità della Classe',
