...
export const it = {
  ...
  teamMode: {
    title: 'Modalità Team',
    subtitle: 'Impulso di capacità sul posto di lavoro (opzionale)',
    ...
    noTeamDesc: 'Inserisci un codice team per unirti al pulse del tuo posto di lavoro',
    joinSuccess: 'Team raggiunto con successo',
    leaveSuccess: 'Team lasciato con successo',
    leaveConfirmTitle: 'Lascia il Team',
    leaveConfirmMessage: 'Puoi unirti di nuovo in qualsiasi momento con il codice team.',
    ...
    aggregateTitle: 'Impulso di Capacità del Team',
    ...
    confidenceLow: 'Bassa',
    totalSignals: '{count} segnali questo periodo',
  ...
  schoolZone: {
    ...
    noSchool: 'Non sei iscritto a una zona scuola',
    noSchoolDesc: 'Inserisci un codice scuola per accedere alle funzionalità scolastiche',
    joinSuccess: 'Zona scuola raggiunta con successo',
    leaveSuccess: 'Zona scuola lasciata con successo',
    leaveConfirmTitle: 'Lascia la Zona Scuola',
    leaveConfirmMessage: 'Puoi unirti di nuovo in qualsiasi momento con il codice scuola.',
    ...
    caregiverViewTitle: 'Scheda Riepilogo Scolastico',
    caregiverViewDesc: 'Genera un riepilogo da condividere con gli educatori',
    generateCard: 'Genera Scheda Riepilogo',
    ...
    educatorViewDesc: 'Vista aggregata dei pattern di capacità della classe',
