...
export const fr = {
  ...
  accessibility: {
    ...
    simpleModeDesc: 'Accessibilité maximale en un seul geste',
    simplified: {
  ...
  teamMode: {
    title: 'Mode Équipe',
    subtitle: 'Pouls de capacité en milieu de travail (optionnel)',
    ...
    leaveSuccess: "Vous avez quitté l'équipe avec succès",
    ...
    participationConfidence: 'Fiabilité des données',
  ...
  schoolZone: {
    title: 'Zone Scolaire',
    subtitle: 'Support de capacité pour les environnements éducatifs',
    joinSchool: "Rejoindre l'école",
    leaveSchool: "Quitter l'école",
    schoolCode: 'Code scolaire',
    schoolCodePlaceholder: 'Entrez le code scolaire',
    schoolCodeInvalid: 'Code scolaire invalide',
    noSchool: 'Pas inscrit dans une zone scolaire',
    noSchoolDesc: 'Entrez un code scolaire pour accéder aux fonctionnalités scolaires',
    ...
    leaveConfirmMessage: 'Vous pouvez rejoindre à tout moment avec le code scolaire.',
    roleLabel: 'Je suis',
    roleStudent: 'Élève',
    ...
    caregiverViewTitle: 'Fiche récapitulative scolaire',
    caregiverViewDesc: 'Générez un résumé à partager avec les éducateurs',
    generateCard: 'Générer la fiche récapitulative',
    ...
    cardCommonDrivers: 'Facteurs courants',
    ...
    educatorViewTitle: 'Aperçu de la capacité de la classe',
    ...
    classConfidence: 'Fiabilité des données',
    envFactors: {
      quiet_space: 'Espace calme',
      sensory_tools: 'Outils sensoriels',
      movement_breaks: 'Pauses de mouvement',
      ...
      time_pressure: 'Pression du temps',
