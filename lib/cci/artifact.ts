...
<div class="page">
  ...
  <!-- FOOTER: ARTIFACT STATEMENT + LEGAL -->
  <div class="footer-section">
    <div class="provider-title">About This Artifact</div>
    <div class="provider-body">
      This artifact is a structured summary of self-reported capacity signals collected over the observation window. <em>It is not a medical device, diagnostic instrument, or clinical assessment.</em> This report is generated from user-reported inputs only and does not constitute a diagnosis, prognosis, or treatment recommendation.
    </div>
    ...
    <div class="capacity-definition" style="margin-top: 10px; margin-bottom: 10px;">
      ...
      <div class="capacity-definition-body">
        <p>This report summarizes self-reported capacity patterns over a defined observation window.</p>
        <p>It may be useful for:</p>
        <ul class="capacity-definition-list">
          <li>identifying periods of high demand or low available capacity</li>
          <li>recognizing environmental or relational patterns</li>
          <li>supporting personal reflection and self-awareness</li>
          <li>sharing context in professional or support conversations</li>
        </ul>
        <p class="capacity-definition-footer">This report reflects self-reported data only. It does not replace professional judgment or guidance.</p>
      </div>
    </div>
    ...
    <div class="legal-block">
      ...
      <div class="legal-body">
        This CCI-Q4 artifact and all underlying methodologies, algorithms, data structures, and presentation formats constitute proprietary intellectual property and trade secrets of Orbital Health Intelligence, Inc. Unauthorized reproduction, distribution, reverse engineering, derivative works, or system emulation is strictly prohibited and may result in civil liability and criminal penalties under applicable trade secret, copyright, and unfair competition laws. This document is provided solely for the confidential use of the intended recipient. Any disclosure, copying, or distribution to unauthorized parties is expressly forbidden. Orbital Health Intelligence, Inc. reserves the right to seek injunctive relief, actual and consequential damages, and recovery of attorneys' fees for any violation of these terms.
      </div>
...
export function createCCIArtifactJSON(
  ...
  return {
    ...
    legal: {
      ...
      disclaimer:
        'This artifact is a structured summary of self-reported capacity signals. ' +
        'It is not a medical device, diagnostic instrument, or clinical assessment.',
    },
    signature: {
      algorithm: 'sha256',
      hash,
