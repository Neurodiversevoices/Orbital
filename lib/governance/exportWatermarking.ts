...
const WATERMARK_DISCLAIMERS = {
  en: 'NON-DIAGNOSTIC | READ-ONLY | This export contains self-reported capacity data and does not constitute formal medical evaluation or professional evaluation.',
